...
query GetResourceById($id: ID!, $filters: JSON, $containsFilters: JSON, $advancedFilters: JSON, $display: Boolean) {
  resource(id: $id) {
    id
    name
    createdAt
    records(filters: $filters, containsFilters: $containsFilters,  advancedFilters: $advancedFilters) {
      id
      data(display: $display)
    }
    fields

...
export const initCustomProperties = (
  ...
  /**
   * Render the questions elements after a survey instance is created
   * DOES NOT WORK
   */
  Survey.renderCallback = function () {
    this.AfterRenderQuestion.add(
      (survey: any, opts: { question: any; htmlElement: any }) => {
        const el = opts.htmlElement;

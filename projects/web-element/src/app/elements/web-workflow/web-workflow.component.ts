...
@Component({
  selector: 'app-web-workflow',
  templateUrl: './web-workflow.component.html',
  styleUrls: ['./web-workflow.component.scss']
})
export class WebWorkflowComponent implements OnInit {

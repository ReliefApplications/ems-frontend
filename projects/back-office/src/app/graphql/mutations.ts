...
mutation editApplication($id: ID!, $name: String, $status: String, $pages: [ID], $permissions: JSON) {
  editApplication(id: $id, name: $name, status: $status pages: $pages, permissions: $permissions) {
    id
    name
    createdAt
    modifiedAt

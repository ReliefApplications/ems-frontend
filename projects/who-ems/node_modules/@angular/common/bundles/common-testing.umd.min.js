...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */((function(){return t.hashUpdate.next({type:"hashchange",state:null,oldUrl:e,newUrl:t.url})}))},t.prototype.getState=function(){return this.state},t}();
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */c.decorators=[{type:e.Injectable}],c.ctorParameters=function(){return[{type:void 0,decorators:[{type:e.Inject,args:[u]},{type:e.Optional}]}]},t.MOCK_PLATFORM_LOCATION_CONFIG=u,t.MockLocationStrategy=i,t.MockPlatformLocation=c,t.SpyLocation=s,Object.defineProperty(t,"__esModule",{value:!0})}));
...
- `npx storybook@latest automigrate --config-dir apps/back-office/.storybook --renderer @storybook/angular`

- `npx storybook@latest automigrate --config-dir apps/front-office/.storybook --renderer @storybook/angular`

- `npx storybook@latest automigrate --config-dir libs/doc-management/.storybook --renderer @storybook/angular`

- `npx storybook@latest automigrate --config-dir libs/shared/.storybook --renderer @storybook/angular`

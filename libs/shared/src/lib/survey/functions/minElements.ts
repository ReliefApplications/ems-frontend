...
/**
 * From all the values of a question, which parent is a panel dynamic, return the min value.
 *
 * @param this Self
 ...
 */
function minElements(this: { survey: SurveyModel }, params: any[]) {
...
/**
 *  Generator for the custom function minElements.
 *
 * @param _ Global options
 * @returns The custom function minElements
 */
// eslint-disable-next-line @typescript-eslint/no-unused-vars
export default (_: GlobalOptions) => minElements;

tinymce.addI18n('fr_FR', {
  ...
  "Your browser doesn't support direct access to the clipboard. Please use the Ctrl+X/C/V keyboard shortcuts instead.":
    "Votre navigateur ne supporte pas la copie directe. Merci d'utiliser les touches Ctrl+X/C/V.",
  Headers: 'Titres',
  'Header 1': 'Titre 1',
  'Header 2': 'Titre 2',
  'Header 3': 'Titre 3',
  ...
  'Save (if save plugin activated)':
    'Enregistrer (si le module save est activ\u00e9)',
  ...
  'Paste your embed code below:':
    "Collez votre code d'int\u00e9gration ci-dessous :",
  Embed: 'Int\u00e9grer',
  Media: 'M\u00e9dia',
  ...
  Avatars: 'Avatars',
  'Max items': "Nombre maximum d'items",
  Shape: 'Forme',
});
